...
function InitialState({profileImage, setProfileImage, name, setName, description, setDescription, mint }) {
  return (
    <div className={style.wrapper}>
      <div className={style.inputFieldsContainer}>
        <div className={style.inputContainer}>
          ...
          <input type="file" id="image-upload" accept=".jpg, .jpeg, .png" className={style.fileInput} placeholder="Image URL" 
